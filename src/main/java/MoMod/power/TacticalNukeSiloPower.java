...
public class TacticalNukeSiloPower extends AbstractMoPower {
    protected Color greenColor2;
    public static final String POWER_ID = MoModHelper.makeID(TacticalNukeSiloPower.class.getSimpleName());
