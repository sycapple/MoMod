...
public class Conscript extends AbstractTrainedCard {
    ...
    public Conscript(boolean isTrained) {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.damageToRandomEnemies(AbstractGameAction.AttackEffect.SLASH_HORIZONTAL);
    }
