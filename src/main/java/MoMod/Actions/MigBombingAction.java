...
public class MigBombingAction extends AbstractGameAction {
    ...
    public MigBombingAction(AbstractPlayer p, int[] multiDamage, DamageInfo.DamageType damageType, boolean freeToPlayOnce, int energyOnUse) {
